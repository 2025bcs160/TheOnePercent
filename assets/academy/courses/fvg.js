  ...
  lessons: [
    ...
    },
    {
      ...
      sections: [
        ...
        {
          h: "Worked example: EURJPY, July 2024",
          p: ["Follow the numbers on the chart. This is the start of the 2024 yen carry-trade unwind, one of the fastest moves EURJPY has made in years."],
          fig: {
            type: "shot",
            src: "we-fvg-eurjpy",
            ...
            meta: "EURJPY · 1D · Jul - Aug 2024",
            alt: "EURJPY daily chart with a bearish fair value gap from 171.572 to 172.269, a retest and a short position",
          },
        },
        {
          h: "Worked example: EURGBP, March 2025",
          p: ["The same German spending news that created the EURUSD gap in lesson 1 also hit EURGBP. This one shows a gap being used almost to its bottom edge, and still holding."],
          fig: {
            type: "shot",
            src: "we-fvg-eurgbp",
            title: "A deep retest that still holds",
            tag: "Worked example",
            steps: ["5 March: a strong up day from 0.83020 to 0.83728. Candle 1 (4 Mar) high 0.83122, candle 3 (6 Mar) low 0.83595: a bullish FVG from 0.83122 to 0.83595, 47 pips.", "20 March: the first pullback reaches 0.83504, inside the top of the gap.", "28 March: a deeper test to 0.83150, less than 3 pips above the bottom edge. There is no daily close below 0.83122, so the gap is still valid.", "3 and 4 April: two strong up days. The 4 April close of 0.84959 clears the March high of 0.84492.", "11 April: 0.87382, about 380 pips above the top of the gap."],
            trade: [["Entry", "0.83550"], ["Stop", "0.83050 · 50 pips"], ["Target", "0.84550 · 2R"], ["Result", "Hit 4 Apr"]],
            caption: "A gap is valid until price closes beyond its far edge. Deep wicks into it are normal, which is why the stop goes below the whole gap, not in the middle.",
            meta: "EURGBP · 1D · Mar - Apr 2025",
            alt: "EURGBP daily chart with a bullish fair value gap from 0.83122 to 0.83595 and two retests",
          },
        },
      ],
      takeaways: [
